...
def plot_bandpass_olr(filter_avg, filter_std, time, day_notation):
    ...
    ax0.plot(time, filter_avg[0][59:(59+92)] - filter_avg[2][59:(59+92)], color='blue', label='early')
    ax0.plot(time, filter_avg[1][59:(59+92)] - filter_avg[2][59:(59+92)], color='red' , label='late' )
    #ax0.plot(time, filter_avg[2][59:(59+92)], color='k' ,   label='average')

    # ============ plot the standard deviation data ============
    ax0.fill_between(time, filter_avg[0][59:(59+92)] - filter_avg[2][59:(59+92)] - filter_std[0][59:(59+92)], filter_avg[0][59:(59+92)] - filter_avg[2][59:(59+92)] + filter_std[0][59:(59+92)], alpha=0.2)
    ax0.fill_between(time, filter_avg[1][59:(59+92)] - filter_avg[2][59:(59+92)] - filter_std[1][59:(59+92)], filter_avg[1][59:(59+92)] - filter_avg[2][59:(59+92)] + filter_std[1][59:(59+92)], alpha=0.2)
