...
f0_April['LSTC_psl_IOB'].data  = (f0_March['LSTC_psl_IOB'].data + f0_April['LSTC_psl_IOB'].data)/3
f0_April['OLR_mari_Afri'].data = (f0_March['OLR_mari_Afri'].data + f0_April['OLR_mari_Afri'].data)/3
#print(f0_March)
...
X_train, X_test, y_train, y_test = train_test_split(np.transpose(np.array([(f0_April['OLR_mari_Afri'].data - np.average(f0_April['OLR_mari_Afri'].data))/np.std(f0_April['OLR_mari_Afri'].data), (f0_April['LSTC_psl_IOB'].data - np.average(f0_April['LSTC_psl_IOB'].data))/np.std(f0_April['LSTC_psl_IOB'].data)])), onset_day_file_42['onset_day'].data, test_size=0.1, random_state=42)
...
new_array = -8.00757291*a + 3.66716196*b + 123.0102402874132
...
std_index = (new_array - np.average(new_array))/np.std(new_array)
