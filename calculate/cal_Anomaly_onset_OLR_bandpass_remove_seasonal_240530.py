...
def band_pass_calculation(data, fs, low_frq, high_frq, order,):
    ...
    result0 = seasonal_decompose(data, model='additive', period=365)
    data    = data - result0.seasonal
...
#    BOB_olr   = np.average(np.average(olr, axis=1), axis=1)
    ...
    ncfile.to_netcdf("/home/sun/data/monsoon_onset_anomaly_analysis/process/ERA5_BOB_OLR_bandpass_filter_30_80_remove_seasonal.nc")