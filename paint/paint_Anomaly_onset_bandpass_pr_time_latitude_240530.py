...
for col in range(2):
    ...
    im  =  ax.contourf(olr_f.time_composite.data[10:], olr_f.lat.data[::-1], olr_combined[col].T, levels=np.linspace(0.5, 3, 11), cmap='Blues', alpha=1, extend='both')
    ...
    ax.set_yticklabels(["10S", "EQ", "10N", "20N"],)
...
plt.savefig("/home/sun/paint/monsoon_onset_composite_ERA5/tp_bandpass_lon_time.pdf")