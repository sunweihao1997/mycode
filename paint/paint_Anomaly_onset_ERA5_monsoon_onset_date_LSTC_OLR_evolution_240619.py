...
def quick_test(array1, array2, array3, fast, slow, left, right, figname):
    ...
    ax.bar([p - bar_width/2 for p in positions], np.average(array2, axis=0), width=bar_width, color='lightskyblue', label='onset early')
    ax.bar([p + bar_width/2 for p in positions], np.average(array3, axis=0), width=bar_width, color='lightsalmon', label='onset late')
...
quick_test((slp_climate - slp_climate)/slp_climate, (olr_early - olr_climate), (olr_late - olr_climate), (olr_fast - olr_climate), (olr_slow - olr_climate),'Maritime-Africa DIFF OLR', ' ', 'ERA5_Maritime_continent_OLR_month_evolution_normal_abnormal_year.png')
quick_test((slp_climate - slp_climate)/slp_climate, (slp_early - slp_climate), (slp_late - slp_climate), (slp_fast - slp_climate), (slp_slow - slp_climate),'LSTC', ' ', 'ERA5_Indian_continent_SLP_month_evolution_normal_abnormal_year.png')
