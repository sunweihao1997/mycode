...
f_ind = xr.open_dataset("/home/sun/data/model_data/climate/b1850_exp/b1850_maritime_atmosphere_new020.nc").sel(lev=200)
...
#im  =  ax.contourf(f_ctl.lon.data,f_ctl.lat.data,ts,np.linspace(-0.5, 0.5, 11),cmap='coolwarm',alpha=1,extend='both')
...
q  =  ax.quiver(f_ctl.lon.data,f_ctl.lat.data, u, v, 
            ...
            scale_units='xy', scale=0.85,        # scale是参考矢量，所以取得越大画出来的箭头就越短
            units='xy', width=0.35,
            transform=proj,
...
# 保存图片  
save_fig(path_out="/home/sun/paint/phd/",file_out="phd_c4_figs4_apr_pr_ctrl_minus_mari_150wind_May.pdf")
